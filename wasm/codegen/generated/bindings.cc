...
EMSCRIPTEN_BINDINGS(mujoco_bindings) {
  ...
  emscripten::class_<MjContact>("MjContact")
    ...
    .property("adhesion", &MjContact::adhesion, &MjContact::set_adhesion)
    .property("dim", &MjContact::dim, &MjContact::set_dim)
    .property("dist", &MjContact::dist, &MjContact::set_dist)
    .property("efc_address", &MjContact::efc_address, &MjContact::set_efc_address)
    .property("elem", &MjContact::elem)
    .property("exclude", &MjContact::exclude, &MjContact::set_exclude)
    ...
    .property("geom2", &MjContact::geom2, &MjContact::set_geom2)
    .property("includemargin", &MjContact::includemargin, &MjContact::set_includemargin)
    .property("mu", &MjContact::mu, &MjContact::set_mu)
  ...
  emscripten::class_<MjData>("MjData")
    ...
    .property("flg_energyvel", &MjData::flg_energyvel, &MjData::set_flg_energyvel)
    .property("flg_rnepost", &MjData::flg_rnepost, &MjData::set_flg_rnepost)
    .property("flg_subtreevel", &MjData::flg_subtreevel, &MjData::set_flg_subtreevel)
    ...
    .property("maxuse_arena", &MjData::maxuse_arena, &MjData::set_maxuse_arena)
    .property("maxuse_con", &MjData::maxuse_con, &MjData::set_maxuse_con)
    .property("maxuse_efc", &MjData::maxuse_efc, &MjData::set_maxuse_efc)
    .property("maxuse_stack", &MjData::maxuse_stack, &MjData::set_maxuse_stack)
    ...
    .property("nA", &MjData::nA, &MjData::set_nA)
    .property("nJ", &MjData::nJ, &MjData::set_nJ)
    .property("nY", &MjData::nY, &MjData::set_nY)
    .property("narena", &MjData::narena, &MjData::set_narena)
    .property("nbody_awake", &MjData::nbody_awake, &MjData::set_nbody_awake)
    .property("nbuffer", &MjData::nbuffer, &MjData::set_nbuffer)
    ...
    .property("nisland", &MjData::nisland, &MjData::set_nisland)
    .property("nl", &MjData::nl, &MjData::set_nl)
    .property("nparent_awake", &MjData::nparent_awake, &MjData::set_nparent_awake)
    .property("nplugin", &MjData::nplugin, &MjData::set_nplugin)
    .property("ntree_awake", &MjData::ntree_awake, &MjData::set_ntree_awake)
    .property("nv_awake", &MjData::nv_awake, &MjData::set_nv_awake)
    .property("parena", &MjData::parena, &MjData::set_parena)
    .property("parent_awake_ind", &MjData::parent_awake_ind)
    .property("pbase", &MjData::pbase, &MjData::set_pbase)
    .property("plugin", &MjData::plugin)
    .property("plugin_data", &MjData::plugin_data)
    .property("plugin_state", &MjData::plugin_state)
    .property("pstack", &MjData::pstack, &MjData::set_pstack)
    ...
    .property("signature", &MjData::signature, &MjData::set_signature)
    ...
    .property("threadlock", &MjData::threadlock, &MjData::set_threadlock)
    .property("threadpool", &MjData::threadpool, &MjData::set_threadpool)
  ...
  emscripten::class_<MjLROpt>("MjLROpt")
    ...
    .property("accel", &MjLROpt::accel, &MjLROpt::set_accel)
    .property("interval", &MjLROpt::interval, &MjLROpt::set_interval)
    .property("inttotal", &MjLROpt::inttotal, &MjLROpt::set_inttotal)
    .property("maxforce", &MjLROpt::maxforce, &MjLROpt::set_maxforce)
    .property("mode", &MjLROpt::mode, &MjLROpt::set_mode)
    .property("timeconst", &MjLROpt::timeconst, &MjLROpt::set_timeconst)
    .property("timestep", &MjLROpt::timestep, &MjLROpt::set_timestep)
    .property("tolrange", &MjLROpt::tolrange, &MjLROpt::set_tolrange)
    .property("useexisting", &MjLROpt::useexisting, &MjLROpt::set_useexisting)
    .property("uselimit", &MjLROpt::uselimit, &MjLROpt::set_uselimit);
  emscripten::class_<MjLogConfig>("MjLogConfig")
    ...
    .property("logto_console", &MjLogConfig::logto_console, &MjLogConfig::set_logto_console)
    .property("logto_file", &MjLogConfig::logto_file, &MjLogConfig::set_logto_file)
  ...
  emscripten::class_<MjModel>("MjModel")
    ...
    .property("actuator_ctrladr", &MjModel::actuator_ctrladr)
    ...
    .property("actuator_outadr", &MjModel::actuator_outadr)
    .property("actuator_outnum", &MjModel::actuator_outnum)
    ...
    .property("flg_adhesion", &MjModel::flg_adhesion, &MjModel::set_flg_adhesion)
    .property("flg_gravcomp", &MjModel::flg_gravcomp, &MjModel::set_flg_gravcomp)
    .property("flg_surfacevel", &MjModel::flg_surfacevel, &MjModel::set_flg_surfacevel)
    ...
    .property("nB", &MjModel::nB, &MjModel::set_nB)
    .property("nC", &MjModel::nC, &MjModel::set_nC)
    .property("nD", &MjModel::nD, &MjModel::set_nD)
    .property("nJfe", &MjModel::nJfe, &MjModel::set_nJfe)
    .property("nJfv", &MjModel::nJfv, &MjModel::set_nJfv)
    .property("nJmom", &MjModel::nJmom, &MjModel::set_nJmom)
    .property("nJten", &MjModel::nJten, &MjModel::set_nJten)
    .property("nM", &MjModel::nM, &MjModel::set_nM)
    .property("na", &MjModel::na, &MjModel::set_na)
    .property("nactuator", &MjModel::nactuator, &MjModel::set_nactuator)
    ...
    .property("narena", &MjModel::narena, &MjModel::set_narena)
    .property("nbody", &MjModel::nbody, &MjModel::set_nbody)
    .property("nbuffer", &MjModel::nbuffer, &MjModel::set_nbuffer)
    .property("nbvh", &MjModel::nbvh, &MjModel::set_nbvh)
    .property("nbvhdynamic", &MjModel::nbvhdynamic, &MjModel::set_nbvhdynamic)
    .property("nbvhstatic", &MjModel::nbvhstatic, &MjModel::set_nbvhstatic)
    .property("ncam", &MjModel::ncam, &MjModel::set_ncam)
    .property("nconmax", &MjModel::nconmax, &MjModel::set_nconmax)
    .property("nefm0L", &MjModel::nefm0L, &MjModel::set_nefm0L)
    .property("nefm0dof", &MjModel::nefm0dof, &MjModel::set_nefm0dof)
    .property("nemax", &MjModel::nemax, &MjModel::set_nemax)
    .property("neq", &MjModel::neq, &MjModel::set_neq)
    .property("nexclude", &MjModel::nexclude, &MjModel::set_nexclude)
    .property("nflex", &MjModel::nflex, &MjModel::set_nflex)
    .property("nflexbending", &MjModel::nflexbending, &MjModel::set_nflexbending)
    .property("nflexedge", &MjModel::nflexedge, &MjModel::set_nflexedge)
    ...
    .property("nflextexcoord", &MjModel::nflextexcoord, &MjModel::set_nflextexcoord)
    .property("nflexvert", &MjModel::nflexvert, &MjModel::set_nflexvert)
    .property("ngeom", &MjModel::ngeom, &MjModel::set_ngeom)
    .property("ngravcomp", &MjModel::ngravcomp, &MjModel::set_ngravcomp)
    .property("nhfield", &MjModel::nhfield, &MjModel::set_nhfield)
    .property("nhfielddata", &MjModel::nhfielddata, &MjModel::set_nhfielddata)
    .property("nhistory", &MjModel::nhistory, &MjModel::set_nhistory)
    .property("njmax", &MjModel::njmax, &MjModel::set_njmax)
    .property("njnt", &MjModel::njnt, &MjModel::set_njnt)
    .property("nkey", &MjModel::nkey, &MjModel::set_nkey)
    .property("nlight", &MjModel::nlight, &MjModel::set_nlight)
    .property("nmat", &MjModel::nmat, &MjModel::set_nmat)
    .property("nmesh", &MjModel::nmesh, &MjModel::set_nmesh)
    .property("nmeshdegmax", &MjModel::nmeshdegmax, &MjModel::set_nmeshdegmax)
    .property("nmeshface", &MjModel::nmeshface, &MjModel::set_nmeshface)
    .property("nmeshgraph", &MjModel::nmeshgraph, &MjModel::set_nmeshgraph)
    .property("nmeshnormal", &MjModel::nmeshnormal, &MjModel::set_nmeshnormal)
    .property("nmeshpoly", &MjModel::nmeshpoly, &MjModel::set_nmeshpoly)
    .property("nmeshpolymap", &MjModel::nmeshpolymap, &MjModel::set_nmeshpolymap)
    .property("nmeshpolyvert", &MjModel::nmeshpolyvert, &MjModel::set_nmeshpolyvert)
    .property("nmeshtexcoord", &MjModel::nmeshtexcoord, &MjModel::set_nmeshtexcoord)
    .property("nmeshvert", &MjModel::nmeshvert, &MjModel::set_nmeshvert)
    .property("nmocap", &MjModel::nmocap, &MjModel::set_nmocap)
    .property("nnames", &MjModel::nnames, &MjModel::set_nnames)
    .property("nnames_map", &MjModel::nnames_map, &MjModel::set_nnames_map)
    .property("nnumeric", &MjModel::nnumeric, &MjModel::set_nnumeric)
    .property("nnumericdata", &MjModel::nnumericdata, &MjModel::set_nnumericdata)
    .property("noct", &MjModel::noct, &MjModel::set_noct)
    .property("nout", &MjModel::nout, &MjModel::set_nout)
    .property("npair", &MjModel::npair, &MjModel::set_npair)
    .property("npaths", &MjModel::npaths, &MjModel::set_npaths)
    .property("nplugin", &MjModel::nplugin, &MjModel::set_nplugin)
    .property("npluginattr", &MjModel::npluginattr, &MjModel::set_npluginattr)
    .property("npluginstate", &MjModel::npluginstate, &MjModel::set_npluginstate)
    .property("npolygonmax", &MjModel::npolygonmax, &MjModel::set_npolygonmax)
    .property("nq", &MjModel::nq, &MjModel::set_nq)
    .property("nsensor", &MjModel::nsensor, &MjModel::set_nsensor)
    .property("nsensordata", &MjModel::nsensordata, &MjModel::set_nsensordata)
    .property("nsite", &MjModel::nsite, &MjModel::set_nsite)
    .property("nskin", &MjModel::nskin, &MjModel::set_nskin)
    .property("nskinbone", &MjModel::nskinbone, &MjModel::set_nskinbone)
    .property("nskinbonevert", &MjModel::nskinbonevert, &MjModel::set_nskinbonevert)
    .property("nskinface", &MjModel::nskinface, &MjModel::set_nskinface)
    .property("nskintexvert", &MjModel::nskintexvert, &MjModel::set_nskintexvert)
    .property("nskinvert", &MjModel::nskinvert, &MjModel::set_nskinvert)
    .property("ntendon", &MjModel::ntendon, &MjModel::set_ntendon)
    .property("ntex", &MjModel::ntex, &MjModel::set_ntex)
    .property("ntexdata", &MjModel::ntexdata, &MjModel::set_ntexdata)
    .property("ntext", &MjModel::ntext, &MjModel::set_ntext)
    .property("ntextdata", &MjModel::ntextdata, &MjModel::set_ntextdata)
    .property("ntree", &MjModel::ntree, &MjModel::set_ntree)
    .property("ntuple", &MjModel::ntuple, &MjModel::set_ntuple)
    .property("ntupledata", &MjModel::ntupledata, &MjModel::set_ntupledata)
    .property("nu", &MjModel::nu, &MjModel::set_nu)
    ...
    .property("nuser_actuator", &MjModel::nuser_actuator, &MjModel::set_nuser_actuator)
    .property("nuser_body", &MjModel::nuser_body, &MjModel::set_nuser_body)
    .property("nuser_cam", &MjModel::nuser_cam, &MjModel::set_nuser_cam)
    .property("nuser_geom", &MjModel::nuser_geom, &MjModel::set_nuser_geom)
    .property("nuser_jnt", &MjModel::nuser_jnt, &MjModel::set_nuser_jnt)
    .property("nuser_sensor", &MjModel::nuser_sensor, &MjModel::set_nuser_sensor)
    .property("nuser_site", &MjModel::nuser_site, &MjModel::set_nuser_site)
    .property("nuser_tendon", &MjModel::nuser_tendon, &MjModel::set_nuser_tendon)
    .property("nuserdata", &MjModel::nuserdata, &MjModel::set_nuserdata)
    .property("nv", &MjModel::nv, &MjModel::set_nv)
    .property("nwrap", &MjModel::nwrap, &MjModel::set_nwrap)
  ...
  emscripten::class_<MjOption>("MjOption")
    ...
    .property("ccd_iterations", &MjOption::ccd_iterations, &MjOption::set_ccd_iterations)
    .property("ccd_tolerance", &MjOption::ccd_tolerance, &MjOption::set_ccd_tolerance)
    .property("cone", &MjOption::cone, &MjOption::set_cone)
    .property("density", &MjOption::density, &MjOption::set_density)
    .property("disableactuator", &MjOption::disableactuator, &MjOption::set_disableactuator)
    .property("disableflags", &MjOption::disableflags, &MjOption::set_disableflags)
    .property("enableflags", &MjOption::enableflags, &MjOption::set_enableflags)
    .property("gravity", &MjOption::gravity)
    .property("impratio", &MjOption::impratio, &MjOption::set_impratio)
    .property("integrator", &MjOption::integrator, &MjOption::set_integrator)
    .property("iterations", &MjOption::iterations, &MjOption::set_iterations)
    .property("jacobian", &MjOption::jacobian, &MjOption::set_jacobian)
    .property("ls_iterations", &MjOption::ls_iterations, &MjOption::set_ls_iterations)
    .property("ls_tolerance", &MjOption::ls_tolerance, &MjOption::set_ls_tolerance)
    .property("magnetic", &MjOption::magnetic)
    .property("noslip_iterations", &MjOption::noslip_iterations, &MjOption::set_noslip_iterations)
    .property("noslip_tolerance", &MjOption::noslip_tolerance, &MjOption::set_noslip_tolerance)
    ...
    .property("solver", &MjOption::solver, &MjOption::set_solver)
    .property("timestep", &MjOption::timestep, &MjOption::set_timestep)
    .property("tolerance", &MjOption::tolerance, &MjOption::set_tolerance)
    .property("viscosity", &MjOption::viscosity, &MjOption::set_viscosity)
    .property("wind", &MjOption::wind);
  emscripten::class_<MjPreContact>("MjPreContact")
    .constructor<>()
    .function("copy", &MjPreContact::copy, take_ownership())
    .property("dist", &MjPreContact::dist, &MjPreContact::set_dist)
  ...
  emscripten::class_<MjSolverStat>("MjSolverStat")
    ...
    .property("gradient", &MjSolverStat::gradient, &MjSolverStat::set_gradient)
    .property("improvement", &MjSolverStat::improvement, &MjSolverStat::set_improvement)
    .property("lineslope", &MjSolverStat::lineslope, &MjSolverStat::set_lineslope)
    .property("nactive", &MjSolverStat::nactive, &MjSolverStat::set_nactive)
    .property("nchange", &MjSolverStat::nchange, &MjSolverStat::set_nchange)
    .property("neval", &MjSolverStat::neval, &MjSolverStat::set_neval)
    .property("nupdate", &MjSolverStat::nupdate, &MjSolverStat::set_nupdate);
  emscripten::class_<MjSpec>("MjSpec")
    ...
    .property("hasImplicitPluginElem", &MjSpec::hasImplicitPluginElem, &MjSpec::set_hasImplicitPluginElem)
    .property("memory", &MjSpec::memory, &MjSpec::set_memory)
    ...
    .property("nconmax", &MjSpec::nconmax, &MjSpec::set_nconmax)
    .property("nemax", &MjSpec::nemax, &MjSpec::set_nemax)
    .property("njmax", &MjSpec::njmax, &MjSpec::set_njmax)
    .property("nkey", &MjSpec::nkey, &MjSpec::set_nkey)
    .property("nstack", &MjSpec::nstack, &MjSpec::set_nstack)
    .property("nuser_actuator", &MjSpec::nuser_actuator, &MjSpec::set_nuser_actuator)
    .property("nuser_body", &MjSpec::nuser_body, &MjSpec::set_nuser_body)
    .property("nuser_cam", &MjSpec::nuser_cam, &MjSpec::set_nuser_cam)
    .property("nuser_geom", &MjSpec::nuser_geom, &MjSpec::set_nuser_geom)
    .property("nuser_jnt", &MjSpec::nuser_jnt, &MjSpec::set_nuser_jnt)
    .property("nuser_sensor", &MjSpec::nuser_sensor, &MjSpec::set_nuser_sensor)
    .property("nuser_site", &MjSpec::nuser_site, &MjSpec::set_nuser_site)
    .property("nuser_tendon", &MjSpec::nuser_tendon, &MjSpec::set_nuser_tendon)
    .property("nuserdata", &MjSpec::nuserdata, &MjSpec::set_nuserdata)
    .property("option", &MjSpec::option, reference())
    .property("stat", &MjSpec::stat, reference())
    .property("strippath", &MjSpec::strippath, &MjSpec::set_strippath)
  ...
  emscripten::class_<MjStatistic>("MjStatistic")
    ...
    .property("extent", &MjStatistic::extent, &MjStatistic::set_extent)
    .property("meaninertia", &MjStatistic::meaninertia, &MjStatistic::set_meaninertia)
    .property("meanmass", &MjStatistic::meanmass, &MjStatistic::set_meanmass)
    .property("meansize", &MjStatistic::meansize, &MjStatistic::set_meansize);
  emscripten::class_<MjTimerStat>("MjTimerStat")
    .constructor<>()
    .function("copy", &MjTimerStat::copy, take_ownership())
    .property("duration", &MjTimerStat::duration, &MjTimerStat::set_duration)
    .property("number", &MjTimerStat::number, &MjTimerStat::set_number);
  ...
  emscripten::class_<MjVisualGlobal>("MjVisualGlobal")
    ...
    .property("azimuth", &MjVisualGlobal::azimuth, &MjVisualGlobal::set_azimuth)
    .property("bvactive", &MjVisualGlobal::bvactive, &MjVisualGlobal::set_bvactive)
    .property("cameraid", &MjVisualGlobal::cameraid, &MjVisualGlobal::set_cameraid)
    .property("elevation", &MjVisualGlobal::elevation, &MjVisualGlobal::set_elevation)
    .property("ellipsoidinertia", &MjVisualGlobal::ellipsoidinertia, &MjVisualGlobal::set_ellipsoidinertia)
    .property("fovy", &MjVisualGlobal::fovy, &MjVisualGlobal::set_fovy)
    .property("glow", &MjVisualGlobal::glow, &MjVisualGlobal::set_glow)
    .property("ipd", &MjVisualGlobal::ipd, &MjVisualGlobal::set_ipd)
    .property("linewidth", &MjVisualGlobal::linewidth, &MjVisualGlobal::set_linewidth)
    .property("offheight", &MjVisualGlobal::offheight, &MjVisualGlobal::set_offheight)
    .property("offwidth", &MjVisualGlobal::offwidth, &MjVisualGlobal::set_offwidth)
    .property("orthographic", &MjVisualGlobal::orthographic, &MjVisualGlobal::set_orthographic)
    .property("realtime", &MjVisualGlobal::realtime, &MjVisualGlobal::set_realtime);
  emscripten::class_<MjVisualHeadlight>("MjVisualHeadlight")
    .constructor<>()
    .function("copy", &MjVisualHeadlight::copy, take_ownership())
    .property("active", &MjVisualHeadlight::active, &MjVisualHeadlight::set_active)
  ...
  emscripten::class_<MjVisualMap>("MjVisualMap")
    ...
    .property("actuatortendon", &MjVisualMap::actuatortendon, &MjVisualMap::set_actuatortendon)
    .property("alpha", &MjVisualMap::alpha, &MjVisualMap::set_alpha)
    .property("fogend", &MjVisualMap::fogend, &MjVisualMap::set_fogend)
    .property("fogstart", &MjVisualMap::fogstart, &MjVisualMap::set_fogstart)
    .property("force", &MjVisualMap::force, &MjVisualMap::set_force)
    .property("haze", &MjVisualMap::haze, &MjVisualMap::set_haze)
    .property("shadowclip", &MjVisualMap::shadowclip, &MjVisualMap::set_shadowclip)
    .property("shadowscale", &MjVisualMap::shadowscale, &MjVisualMap::set_shadowscale)
    .property("stiffness", &MjVisualMap::stiffness, &MjVisualMap::set_stiffness)
    .property("stiffnessrot", &MjVisualMap::stiffnessrot, &MjVisualMap::set_stiffnessrot)
    .property("torque", &MjVisualMap::torque, &MjVisualMap::set_torque)
    .property("zfar", &MjVisualMap::zfar, &MjVisualMap::set_zfar)
    .property("znear", &MjVisualMap::znear, &MjVisualMap::set_znear);
  emscripten::class_<MjVisualQuality>("MjVisualQuality")
    .constructor<>()
    .function("copy", &MjVisualQuality::copy, take_ownership())
    .property("numquads", &MjVisualQuality::numquads, &MjVisualQuality::set_numquads)
    .property("numslices", &MjVisualQuality::numslices, &MjVisualQuality::set_numslices)
    .property("numstacks", &MjVisualQuality::numstacks, &MjVisualQuality::set_numstacks)
    .property("offsamples", &MjVisualQuality::offsamples, &MjVisualQuality::set_offsamples)
    .property("shadowsize", &MjVisualQuality::shadowsize, &MjVisualQuality::set_shadowsize);
  ...
  emscripten::class_<MjVisualScale>("MjVisualScale")
    ...
    .property("actuatorlength", &MjVisualScale::actuatorlength, &MjVisualScale::set_actuatorlength)
    .property("actuatorwidth", &MjVisualScale::actuatorwidth, &MjVisualScale::set_actuatorwidth)
    .property("camera", &MjVisualScale::camera, &MjVisualScale::set_camera)
    .property("com", &MjVisualScale::com, &MjVisualScale::set_com)
    .property("connect", &MjVisualScale::connect, &MjVisualScale::set_connect)
    .property("constraint", &MjVisualScale::constraint, &MjVisualScale::set_constraint)
    .property("contactheight", &MjVisualScale::contactheight, &MjVisualScale::set_contactheight)
    .property("contactwidth", &MjVisualScale::contactwidth, &MjVisualScale::set_contactwidth)
    .property("forcewidth", &MjVisualScale::forcewidth, &MjVisualScale::set_forcewidth)
    .property("framelength", &MjVisualScale::framelength, &MjVisualScale::set_framelength)
    .property("framewidth", &MjVisualScale::framewidth, &MjVisualScale::set_framewidth)
    .property("frustum", &MjVisualScale::frustum, &MjVisualScale::set_frustum)
    .property("jointlength", &MjVisualScale::jointlength, &MjVisualScale::set_jointlength)
    .property("jointwidth", &MjVisualScale::jointwidth, &MjVisualScale::set_jointwidth)
    .property("light", &MjVisualScale::light, &MjVisualScale::set_light)
    .property("selectpoint", &MjVisualScale::selectpoint, &MjVisualScale::set_selectpoint)
    .property("slidercrank", &MjVisualScale::slidercrank, &MjVisualScale::set_slidercrank);
  emscripten::class_<MjWarningStat>("MjWarningStat")
    .constructor<>()
    .function("copy", &MjWarningStat::copy, take_ownership())
    .property("lastinfo", &MjWarningStat::lastinfo, &MjWarningStat::set_lastinfo)
    .property("number", &MjWarningStat::number, &MjWarningStat::set_number);
  emscripten::class_<MjsActuator>("MjsActuator")
    .property("actdim", &MjsActuator::actdim, &MjsActuator::set_actdim)
    .property("actearly", &MjsActuator::actearly, &MjsActuator::set_actearly)
    .property("actlimited", &MjsActuator::actlimited, &MjsActuator::set_actlimited)
    .property("actrange", &MjsActuator::actrange)
    .property("armature", &MjsActuator::armature, &MjsActuator::set_armature)
    .property("biasprm", &MjsActuator::biasprm)
    .property("biastype", &MjsActuator::biastype, &MjsActuator::set_biastype)
    .property("cranklength", &MjsActuator::cranklength, &MjsActuator::set_cranklength)
    .property("ctrllimited", &MjsActuator::ctrllimited, &MjsActuator::set_ctrllimited)
    .property("ctrlrange", &MjsActuator::ctrlrange)
    .property("ctrlspec", &MjsActuator::ctrlspec, &MjsActuator::set_ctrlspec)
    .property("damping", &MjsActuator::damping)
    .property("delay", &MjsActuator::delay, &MjsActuator::set_delay)
    .property("dynprm", &MjsActuator::dynprm)
    .property("dyntype", &MjsActuator::dyntype, &MjsActuator::set_dyntype)
    .property("element", &MjsActuator::element, reference())
    .property("ffrange", &MjsActuator::ffrange)
    .property("forcelimited", &MjsActuator::forcelimited, &MjsActuator::set_forcelimited)
    .property("forcerange", &MjsActuator::forcerange)
    .property("gainprm", &MjsActuator::gainprm)
    .property("gaintype", &MjsActuator::gaintype, &MjsActuator::set_gaintype)
    .property("gear", &MjsActuator::gear)
    .property("group", &MjsActuator::group, &MjsActuator::set_group)
    .property("info", &MjsActuator::info, &MjsActuator::set_info, reference())
    .property("inheritrange", &MjsActuator::inheritrange, &MjsActuator::set_inheritrange)
    .property("interp", &MjsActuator::interp, &MjsActuator::set_interp)
    .property("lengthrange", &MjsActuator::lengthrange)
    .property("nsample", &MjsActuator::nsample, &MjsActuator::set_nsample)
  ...
  emscripten::class_<MjsAuthored>("MjsAuthored")
    .property("disableactuator", &MjsAuthored::disableactuator, &MjsAuthored::set_disableactuator)
    .property("disableflags", &MjsAuthored::disableflags, &MjsAuthored::set_disableflags)
    .property("enableflags", &MjsAuthored::enableflags, &MjsAuthored::set_enableflags)
    .property("option", &MjsAuthored::option, &MjsAuthored::set_option)
    .property("visual_global", &MjsAuthored::visual_global, &MjsAuthored::set_visual_global)
    .property("visual_headlight", &MjsAuthored::visual_headlight, &MjsAuthored::set_visual_headlight)
    .property("visual_map", &MjsAuthored::visual_map, &MjsAuthored::set_visual_map)
    .property("visual_quality", &MjsAuthored::visual_quality, &MjsAuthored::set_visual_quality)
    .property("visual_rgba", &MjsAuthored::visual_rgba, &MjsAuthored::set_visual_rgba)
    .property("visual_scale", &MjsAuthored::visual_scale, &MjsAuthored::set_visual_scale);
  emscripten::class_<MjsBody>("MjsBody")
    ...
    .property("mass", &MjsBody::mass, &MjsBody::set_mass)
    .property("mocap", &MjsBody::mocap, &MjsBody::set_mocap)
    .property("plugin", &MjsBody::plugin, reference())
    .property("pos", &MjsBody::pos)
    .property("quat", &MjsBody::quat)
    .property("simple", &MjsBody::simple, &MjsBody::set_simple)
    .property("sleep", &MjsBody::sleep, &MjsBody::set_sleep)
  ...
  emscripten::class_<MjsCamera>("MjsCamera")
    ...
    .property("fovy", &MjsCamera::fovy, &MjsCamera::set_fovy)
    .property("info", &MjsCamera::info, &MjsCamera::set_info, reference())
    .property("intrinsic", &MjsCamera::intrinsic)
    .property("ipd", &MjsCamera::ipd, &MjsCamera::set_ipd)
    .property("mode", &MjsCamera::mode, &MjsCamera::set_mode)
    .property("output", &MjsCamera::output, &MjsCamera::set_output)
    ...
    .property("proj", &MjsCamera::proj, &MjsCamera::set_proj)
  ...
  emscripten::class_<MjsCompiler>("MjsCompiler")
    ...
    .property("alignfree", &MjsCompiler::alignfree, &MjsCompiler::set_alignfree)
    .property("authored", &MjsCompiler::authored, &MjsCompiler::set_authored)
    .property("autolimits", &MjsCompiler::autolimits, &MjsCompiler::set_autolimits)
    .property("balanceinertia", &MjsCompiler::balanceinertia, &MjsCompiler::set_balanceinertia)
    .property("boundinertia", &MjsCompiler::boundinertia, &MjsCompiler::set_boundinertia)
    .property("boundmass", &MjsCompiler::boundmass, &MjsCompiler::set_boundmass)
    .property("conflict", &MjsCompiler::conflict, &MjsCompiler::set_conflict)
    .property("degree", &MjsCompiler::degree, &MjsCompiler::set_degree)
    .property("discardvisual", &MjsCompiler::discardvisual, &MjsCompiler::set_discardvisual)
    .property("eulerseq", &MjsCompiler::eulerseq)
    .property("fitaabb", &MjsCompiler::fitaabb, &MjsCompiler::set_fitaabb)
    .property("fusestatic", &MjsCompiler::fusestatic, &MjsCompiler::set_fusestatic)
    ...
    .property("usethread", &MjsCompiler::usethread, &MjsCompiler::set_usethread);
  ...
  emscripten::class_<MjsElement>("MjsElement")
    .property("elemtype", &MjsElement::elemtype, &MjsElement::set_elemtype)
    .property("signature", &MjsElement::signature, &MjsElement::set_signature);
  emscripten::class_<MjsEquality>("MjsEquality")
    .property("active", &MjsEquality::active, &MjsEquality::set_active)
    ...
    .property("objtype", &MjsEquality::objtype, &MjsEquality::set_objtype)
    .property("solimp", &MjsEquality::solimp)
    .property("solref", &MjsEquality::solref)
    .property("type", &MjsEquality::type, &MjsEquality::set_type);
  ...
  emscripten::class_<MjsFlex>("MjsFlex")
    .property("activelayers", &MjsFlex::activelayers, &MjsFlex::set_activelayers)
    .property("cellcount", &MjsFlex::cellcount)
    .property("conaffinity", &MjsFlex::conaffinity, &MjsFlex::set_conaffinity)
    .property("condim", &MjsFlex::condim, &MjsFlex::set_condim)
    .property("contype", &MjsFlex::contype, &MjsFlex::set_contype)
    .property("damping", &MjsFlex::damping, &MjsFlex::set_damping)
    .property("dim", &MjsFlex::dim, &MjsFlex::set_dim)
    ...
    .property("flatskin", &MjsFlex::flatskin, &MjsFlex::set_flatskin)
    ...
    .property("order", &MjsFlex::order, &MjsFlex::set_order)
    .property("passive", &MjsFlex::passive, &MjsFlex::set_passive)
    .property("poisson", &MjsFlex::poisson, &MjsFlex::set_poisson)
    .property("priority", &MjsFlex::priority, &MjsFlex::set_priority)
    .property("radius", &MjsFlex::radius, &MjsFlex::set_radius)
    ...
    .property("thickness", &MjsFlex::thickness, &MjsFlex::set_thickness)
    .property("vert", &MjsFlex::vert, reference())
    .property("vertbody", &MjsFlex::vertbody, reference())
    .property("young", &MjsFlex::young, &MjsFlex::set_young);
  ...
  emscripten::class_<MjsGeom>("MjsGeom")
    .property("adhesion", &MjsGeom::adhesion, &MjsGeom::set_adhesion)
    .property("alt", &MjsGeom::alt, reference())
    .property("conaffinity", &MjsGeom::conaffinity, &MjsGeom::set_conaffinity)
    .property("condim", &MjsGeom::condim, &MjsGeom::set_condim)
    .property("contype", &MjsGeom::contype, &MjsGeom::set_contype)
    .property("density", &MjsGeom::density, &MjsGeom::set_density)
    .property("element", &MjsGeom::element, reference())
    .property("fitscale", &MjsGeom::fitscale, &MjsGeom::set_fitscale)
    .property("fluid_coefs", &MjsGeom::fluid_coefs)
    .property("fluid_ellipsoid", &MjsGeom::fluid_ellipsoid, &MjsGeom::set_fluid_ellipsoid)
    .property("friction", &MjsGeom::friction)
    .property("fromto", &MjsGeom::fromto)
    .property("gap", &MjsGeom::gap, &MjsGeom::set_gap)
    .property("group", &MjsGeom::group, &MjsGeom::set_group)
    ...
    .property("margin", &MjsGeom::margin, &MjsGeom::set_margin)
    .property("mass", &MjsGeom::mass, &MjsGeom::set_mass)
    ...
    .property("priority", &MjsGeom::priority, &MjsGeom::set_priority)
    .property("quat", &MjsGeom::quat)
    .property("rgba", &MjsGeom::rgba)
    .property("size", &MjsGeom::size)
    .property("solimp", &MjsGeom::solimp)
    .property("solmix", &MjsGeom::solmix, &MjsGeom::set_solmix)
    .property("solref", &MjsGeom::solref)
    .property("surfacevel", &MjsGeom::surfacevel)
    .property("type", &MjsGeom::type, &MjsGeom::set_type)
    .property("typeinertia", &MjsGeom::typeinertia, &MjsGeom::set_typeinertia)
  ...
  emscripten::class_<MjsHField>("MjsHField")
    ...
    .property("ncol", &MjsHField::ncol, &MjsHField::set_ncol)
    .property("nrow", &MjsHField::nrow, &MjsHField::set_nrow)
    .property("size", &MjsHField::size)
    .property("userdata", &MjsHField::userdata, reference());
  emscripten::class_<MjsJoint>("MjsJoint")
    .property("actfrclimited", &MjsJoint::actfrclimited, &MjsJoint::set_actfrclimited)
    .property("actfrcrange", &MjsJoint::actfrcrange)
    .property("actgravcomp", &MjsJoint::actgravcomp, &MjsJoint::set_actgravcomp)
    .property("align", &MjsJoint::align, &MjsJoint::set_align)
    ...
    .property("frictionloss", &MjsJoint::frictionloss, &MjsJoint::set_frictionloss)
    .property("group", &MjsJoint::group, &MjsJoint::set_group)
    .property("info", &MjsJoint::info, &MjsJoint::set_info, reference())
    .property("limited", &MjsJoint::limited, &MjsJoint::set_limited)
    .property("margin", &MjsJoint::margin, &MjsJoint::set_margin)
    .property("pos", &MjsJoint::pos)
    .property("range", &MjsJoint::range)
    .property("ref", &MjsJoint::ref, &MjsJoint::set_ref)
    ...
    .property("springref", &MjsJoint::springref, &MjsJoint::set_springref)
    .property("stiffness", &MjsJoint::stiffness)
    .property("type", &MjsJoint::type, &MjsJoint::set_type)
  ...
  emscripten::class_<MjsKey>("MjsKey")
    ...
    .property("time", &MjsKey::time, &MjsKey::set_time);
  emscripten::class_<MjsLight>("MjsLight")
    .property("active", &MjsLight::active, &MjsLight::set_active)
    .property("ambient", &MjsLight::ambient)
    .property("attenuation", &MjsLight::attenuation)
    .property("bulbradius", &MjsLight::bulbradius, &MjsLight::set_bulbradius)
    .property("castshadow", &MjsLight::castshadow, &MjsLight::set_castshadow)
    .property("cutoff", &MjsLight::cutoff, &MjsLight::set_cutoff)
    .property("diffuse", &MjsLight::diffuse)
    .property("dir", &MjsLight::dir)
    .property("element", &MjsLight::element, reference())
    .property("exponent", &MjsLight::exponent, &MjsLight::set_exponent)
    .property("info", &MjsLight::info, &MjsLight::set_info, reference())
    .property("intensity", &MjsLight::intensity, &MjsLight::set_intensity)
    .property("mode", &MjsLight::mode, &MjsLight::set_mode)
    .property("pos", &MjsLight::pos)
    .property("range", &MjsLight::range, &MjsLight::set_range)
    ...
    .property("type", &MjsLight::type, &MjsLight::set_type);
  emscripten::class_<MjsMaterial>("MjsMaterial")
    .property("element", &MjsMaterial::element, reference())
    .property("emission", &MjsMaterial::emission, &MjsMaterial::set_emission)
    .property("info", &MjsMaterial::info, &MjsMaterial::set_info, reference())
    .property("metallic", &MjsMaterial::metallic, &MjsMaterial::set_metallic)
    .property("reflectance", &MjsMaterial::reflectance, &MjsMaterial::set_reflectance)
    .property("rgba", &MjsMaterial::rgba)
    .property("roughness", &MjsMaterial::roughness, &MjsMaterial::set_roughness)
    .property("shininess", &MjsMaterial::shininess, &MjsMaterial::set_shininess)
    .property("specular", &MjsMaterial::specular, &MjsMaterial::set_specular)
    .property("texrepeat", &MjsMaterial::texrepeat)
    .property("textures", &MjsMaterial::textures, reference())
    .property("texuniform", &MjsMaterial::texuniform, &MjsMaterial::set_texuniform);
  emscripten::class_<MjsMesh>("MjsMesh")
    ...
    .property("inertia", &MjsMesh::inertia, &MjsMesh::set_inertia)
    .property("info", &MjsMesh::info, &MjsMesh::set_info, reference())
    .property("material", &MjsMesh::material, &MjsMesh::set_material, reference())
    .property("maxhullvert", &MjsMesh::maxhullvert, &MjsMesh::set_maxhullvert)
    .property("needsdf", &MjsMesh::needsdf, &MjsMesh::set_needsdf)
    .property("octree_maxdepth", &MjsMesh::octree_maxdepth, &MjsMesh::set_octree_maxdepth)
    ...
    .property("smoothnormal", &MjsMesh::smoothnormal, &MjsMesh::set_smoothnormal)
  ...
  emscripten::class_<MjsNumeric>("MjsNumeric")
    ...
    .property("size", &MjsNumeric::size, &MjsNumeric::set_size);
  emscripten::class_<MjsOrientation>("MjsOrientation")
    ...
    .property("type", &MjsOrientation::type, &MjsOrientation::set_type)
    .property("xyaxes", &MjsOrientation::xyaxes)
    .property("zaxis", &MjsOrientation::zaxis);
  emscripten::class_<MjsPair>("MjsPair")
    .property("adhesion", &MjsPair::adhesion, &MjsPair::set_adhesion)
    ...
    .property("gap", &MjsPair::gap, &MjsPair::set_gap)
    ...
    .property("margin", &MjsPair::margin, &MjsPair::set_margin)
  ...
  emscripten::class_<MjsPlugin>("MjsPlugin")
    .property("active", &MjsPlugin::active, &MjsPlugin::set_active)
  ...
  emscripten::class_<MjsSensor>("MjsSensor")
    .property("cutoff", &MjsSensor::cutoff, &MjsSensor::set_cutoff)
    .property("datatype", &MjsSensor::datatype, &MjsSensor::set_datatype)
    .property("delay", &MjsSensor::delay, &MjsSensor::set_delay)
    .property("dim", &MjsSensor::dim, &MjsSensor::set_dim)
    .property("element", &MjsSensor::element, reference())
    .property("info", &MjsSensor::info, &MjsSensor::set_info, reference())
    .property("interp", &MjsSensor::interp, &MjsSensor::set_interp)
    .property("interval", &MjsSensor::interval)
    .property("intprm", &MjsSensor::intprm)
    .property("needstage", &MjsSensor::needstage, &MjsSensor::set_needstage)
    .property("noise", &MjsSensor::noise, &MjsSensor::set_noise)
    .property("nsample", &MjsSensor::nsample, &MjsSensor::set_nsample)
    .property("objname", &MjsSensor::objname, &MjsSensor::set_objname, reference())
    .property("objtype", &MjsSensor::objtype, &MjsSensor::set_objtype)
    .property("plugin", &MjsSensor::plugin, reference())
    .property("refname", &MjsSensor::refname, &MjsSensor::set_refname, reference())
    .property("reftype", &MjsSensor::reftype, &MjsSensor::set_reftype)
    .property("type", &MjsSensor::type, &MjsSensor::set_type)
  ...
  emscripten::class_<MjsSite>("MjsSite")
    ...
    .property("type", &MjsSite::type, &MjsSite::set_type)
  ...
  emscripten::class_<MjsSkin>("MjsSkin")
    ...
    .property("group", &MjsSkin::group, &MjsSkin::set_group)
    .property("inflate", &MjsSkin::inflate, &MjsSkin::set_inflate)
  ...
  emscripten::class_<MjsTendon>("MjsTendon")
    .property("actfrclimited", &MjsTendon::actfrclimited, &MjsTendon::set_actfrclimited)
    .property("actfrcrange", &MjsTendon::actfrcrange)
    .property("armature", &MjsTendon::armature, &MjsTendon::set_armature)
    .property("damping", &MjsTendon::damping)
    .property("element", &MjsTendon::element, reference())
    .property("frictionloss", &MjsTendon::frictionloss, &MjsTendon::set_frictionloss)
    .property("group", &MjsTendon::group, &MjsTendon::set_group)
    .property("info", &MjsTendon::info, &MjsTendon::set_info, reference())
    .property("limited", &MjsTendon::limited, &MjsTendon::set_limited)
    .property("margin", &MjsTendon::margin, &MjsTendon::set_margin)
    ...
    .property("width", &MjsTendon::width, &MjsTendon::set_width);
  ...
  emscripten::class_<MjsTexture>("MjsTexture")
    .property("builtin", &MjsTexture::builtin, &MjsTexture::set_builtin)
    .property("colorspace", &MjsTexture::colorspace, &MjsTexture::set_colorspace)
    ...
    .property("hflip", &MjsTexture::hflip, &MjsTexture::set_hflip)
  ...
  emscripten::class_<MjsWrap>("MjsWrap")
    ...
    .property("type", &MjsWrap::type, &MjsWrap::set_type);
  emscripten::class_<MjvCamera>("MjvCamera")
    .constructor<>()
    .function("copy", &MjvCamera::copy, take_ownership())
    .property("azimuth", &MjvCamera::azimuth, &MjvCamera::set_azimuth)
    .property("distance", &MjvCamera::distance, &MjvCamera::set_distance)
    .property("elevation", &MjvCamera::elevation, &MjvCamera::set_elevation)
    .property("fixedcamid", &MjvCamera::fixedcamid, &MjvCamera::set_fixedcamid)
    .property("lookat", &MjvCamera::lookat)
    .property("orthographic", &MjvCamera::orthographic, &MjvCamera::set_orthographic)
    .property("trackbodyid", &MjvCamera::trackbodyid, &MjvCamera::set_trackbodyid)
    .property("type", &MjvCamera::type, &MjvCamera::set_type);
  emscripten::class_<MjvFigure>("MjvFigure")
    .constructor<>()
    .function("copy", &MjvFigure::copy, take_ownership())
    .property("figurergba", &MjvFigure::figurergba)
    .property("flg_barplot", &MjvFigure::flg_barplot, &MjvFigure::set_flg_barplot)
    .property("flg_extend", &MjvFigure::flg_extend, &MjvFigure::set_flg_extend)
    .property("flg_legend", &MjvFigure::flg_legend, &MjvFigure::set_flg_legend)
    .property("flg_selection", &MjvFigure::flg_selection, &MjvFigure::set_flg_selection)
    .property("flg_symmetric", &MjvFigure::flg_symmetric, &MjvFigure::set_flg_symmetric)
    .property("flg_ticklabel", &MjvFigure::flg_ticklabel)
    .property("gridrgb", &MjvFigure::gridrgb)
    .property("gridsize", &MjvFigure::gridsize)
    .property("gridwidth", &MjvFigure::gridwidth, &MjvFigure::set_gridwidth)
    .property("highlight", &MjvFigure::highlight)
    .property("highlightid", &MjvFigure::highlightid, &MjvFigure::set_highlightid)
    .property("legendoffset", &MjvFigure::legendoffset, &MjvFigure::set_legendoffset)
    ...
    .property("linewidth", &MjvFigure::linewidth, &MjvFigure::set_linewidth)
    .property("minwidth", &MjvFigure::minwidth)
    .property("panergba", &MjvFigure::panergba)
    .property("range", &MjvFigure::range)
    .property("selection", &MjvFigure::selection, &MjvFigure::set_selection)
    .property("subplot", &MjvFigure::subplot, &MjvFigure::set_subplot)
  ...
  emscripten::class_<MjvGLCamera>("MjvGLCamera")
    ...
    .property("frustum_bottom", &MjvGLCamera::frustum_bottom, &MjvGLCamera::set_frustum_bottom)
    .property("frustum_center", &MjvGLCamera::frustum_center, &MjvGLCamera::set_frustum_center)
    .property("frustum_far", &MjvGLCamera::frustum_far, &MjvGLCamera::set_frustum_far)
    .property("frustum_near", &MjvGLCamera::frustum_near, &MjvGLCamera::set_frustum_near)
    .property("frustum_top", &MjvGLCamera::frustum_top, &MjvGLCamera::set_frustum_top)
    .property("frustum_width", &MjvGLCamera::frustum_width, &MjvGLCamera::set_frustum_width)
    .property("orthographic", &MjvGLCamera::orthographic, &MjvGLCamera::set_orthographic)
  ...
  emscripten::class_<MjvGeom>("MjvGeom")
    ...
    .property("camdist", &MjvGeom::camdist, &MjvGeom::set_camdist)
    .property("category", &MjvGeom::category, &MjvGeom::set_category)
    .property("dataid", &MjvGeom::dataid, &MjvGeom::set_dataid)
    .property("emission", &MjvGeom::emission, &MjvGeom::set_emission)
    .property("label", &MjvGeom::label)
    .property("mat", &MjvGeom::mat)
    .property("matid", &MjvGeom::matid, &MjvGeom::set_matid)
    .property("modelrbound", &MjvGeom::modelrbound, &MjvGeom::set_modelrbound)
    .property("objid", &MjvGeom::objid, &MjvGeom::set_objid)
    .property("objtype", &MjvGeom::objtype, &MjvGeom::set_objtype)
    .property("pos", &MjvGeom::pos)
    .property("reflectance", &MjvGeom::reflectance, &MjvGeom::set_reflectance)
    .property("rgba", &MjvGeom::rgba)
    .property("segid", &MjvGeom::segid, &MjvGeom::set_segid)
    .property("shininess", &MjvGeom::shininess, &MjvGeom::set_shininess)
    .property("size", &MjvGeom::size)
    .property("specular", &MjvGeom::specular, &MjvGeom::set_specular)
    .property("texcoord", &MjvGeom::texcoord, &MjvGeom::set_texcoord)
    .property("texid", &MjvGeom::texid, &MjvGeom::set_texid)
    .property("texrepeat", &MjvGeom::texrepeat)
    .property("texuniform", &MjvGeom::texuniform, &MjvGeom::set_texuniform)
    .property("transparent", &MjvGeom::transparent, &MjvGeom::set_transparent)
    .property("type", &MjvGeom::type, &MjvGeom::set_type);
  emscripten::class_<MjvLight>("MjvLight")
    ...
    .property("bulbradius", &MjvLight::bulbradius, &MjvLight::set_bulbradius)
    .property("castshadow", &MjvLight::castshadow, &MjvLight::set_castshadow)
    .property("cutoff", &MjvLight::cutoff, &MjvLight::set_cutoff)
    .property("diffuse", &MjvLight::diffuse)
    .property("dir", &MjvLight::dir)
    .property("exponent", &MjvLight::exponent, &MjvLight::set_exponent)
    .property("headlight", &MjvLight::headlight, &MjvLight::set_headlight)
    .property("id", &MjvLight::id, &MjvLight::set_id)
    .property("intensity", &MjvLight::intensity, &MjvLight::set_intensity)
    .property("pos", &MjvLight::pos)
    .property("range", &MjvLight::range, &MjvLight::set_range)
    .property("softness", &MjvLight::softness, &MjvLight::set_softness)
    .property("specular", &MjvLight::specular)
    .property("texid", &MjvLight::texid, &MjvLight::set_texid)
    .property("type", &MjvLight::type, &MjvLight::set_type);
  emscripten::class_<MjvOption>("MjvOption")
    ...
    .property("bvh_depth", &MjvOption::bvh_depth, &MjvOption::set_bvh_depth)
    .property("flags", &MjvOption::flags)
    .property("flex_layer", &MjvOption::flex_layer, &MjvOption::set_flex_layer)
    .property("flexgroup", &MjvOption::flexgroup)
    .property("frame", &MjvOption::frame, &MjvOption::set_frame)
    .property("geomgroup", &MjvOption::geomgroup)
    .property("jointgroup", &MjvOption::jointgroup)
    .property("label", &MjvOption::label, &MjvOption::set_label)
  ...
  emscripten::class_<MjvPerturb>("MjvPerturb")
    ...
    .property("active", &MjvPerturb::active, &MjvPerturb::set_active)
    .property("active2", &MjvPerturb::active2, &MjvPerturb::set_active2)
    .property("flexselect", &MjvPerturb::flexselect, &MjvPerturb::set_flexselect)
    .property("localmass", &MjvPerturb::localmass, &MjvPerturb::set_localmass)
    ...
    .property("scale", &MjvPerturb::scale, &MjvPerturb::set_scale)
    .property("select", &MjvPerturb::select, &MjvPerturb::set_select)
    .property("skinselect", &MjvPerturb::skinselect, &MjvPerturb::set_skinselect);
  emscripten::class_<MjvScene>("MjvScene")
    .constructor<MjModel *, int>()
    .constructor<>()
    .property("camera", &MjvScene::camera)
    .property("enabletransform", &MjvScene::enabletransform, &MjvScene::set_enabletransform)
    ...
    .property("flexvertopt", &MjvScene::flexvertopt, &MjvScene::set_flexvertopt)
    .property("framergb", &MjvScene::framergb)
    .property("framewidth", &MjvScene::framewidth, &MjvScene::set_framewidth)
    .property("geomorder", &MjvScene::geomorder)
    .property("geoms", &MjvScene::geoms)
    .property("lights", &MjvScene::lights)
    .property("maxgeom", &MjvScene::maxgeom, &MjvScene::set_maxgeom)
    .property("nflex", &MjvScene::nflex, &MjvScene::set_nflex)
    .property("ngeom", &MjvScene::ngeom, &MjvScene::set_ngeom)
    .property("nlight", &MjvScene::nlight, &MjvScene::set_nlight)
    .property("nskin", &MjvScene::nskin, &MjvScene::set_nskin)
    .property("rotate", &MjvScene::rotate)
    .property("scale", &MjvScene::scale, &MjvScene::set_scale)
    ...
    .property("status", &MjvScene::status, &MjvScene::set_status)
    .property("stereo", &MjvScene::stereo, &MjvScene::set_stereo)
