...
``/Applications/MuJoCo.app/Contents/Frameworks/mujoco.framework/Versions/Current/libmujoco.3.13.0.dylib`` (it can be
...
``~/.mujoco/mujoco-3.13.0/lib/libmujoco.so.3.13.0`` and rename it as ``libmujoco.so``.
